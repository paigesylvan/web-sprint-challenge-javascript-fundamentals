...
const lowerCaseNames = arr => arr.map(item => item.animal_name.toLowerCase())

  //function lowerCaseNames(arr){
  //return arr.map(item => item.animal_name.toLowerCase())

   // let newNames = arr.map(item => item.animal_name.toLowerCase())
   // return newNames;
  //}
...
function greeting(firstName, lastName){
  ...
  console.log(greeting('paige', 'sylvan'));
